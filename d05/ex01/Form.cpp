...
Form::Form() : _name("form"), _grade(1), _execute(1), _sign(false){
}

Form::Form(std::string name, int grade, int execute) : _name(name), _grade(grade), _execute(execute), _sign(false) {
